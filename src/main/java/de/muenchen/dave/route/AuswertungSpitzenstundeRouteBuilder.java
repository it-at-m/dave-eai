...
@Component
public class AuswertungSpitzenstundeRouteBuilder extends RouteBuilder {

    public static final String ROUTE_ID_JSON_TO_CSV = "spitzenstunde_json_to_csv";

    public static final String ROUTE_JSON_TO_CSV = "direct:" + ROUTE_ID_JSON_TO_CSV;

    public static final String ROUTE_EXCEPTION = "direct:spitzenstunde_exceptionHandling";

    private static final String HEADER_NAME_CONTENT_TYPE = "content-type";

    private static final String HEADER_VALUE_CONTENT_TYPE_TEXT_CSV = "text/csv";

    private final ListJacksonDataFormat json = new ListJacksonDataFormat(LadeAuswertungSpitzenstundeDTO.class);
